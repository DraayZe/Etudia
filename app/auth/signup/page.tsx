    ...
    return (
      <div className="relative flex min-h-screen items-center justify-center bg-black text-white overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-md px-6 text-center">
          ...
          <h1 className="font-anybody text-2xl font-bold">Vérifie ton email</h1>
          <p className="mt-3 font-anybody text-sm text-white/50">
          ...
          <Link
            href="/auth/login"
            className="mt-8 inline-block font-anybody text-sm font-medium text-white/50 transition-colors hover:text-white"
          >
    ...
    <div className="relative flex min-h-screen items-center justify-center bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="mb-10 text-center">
          ...
          <h1 className="mt-6 font-anybody text-2xl font-bold">
            Crée ton compte
          </h1>
          <p className="mt-2 font-anybody text-sm text-white/50">
            Commence à réviser plus intelligemment
          </p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <div>
            <label htmlFor="password" className="mb-1.5 block font-anybody text-sm font-medium text-white/70">
              Mot de passe
            </label>
            <input
              id="password"
